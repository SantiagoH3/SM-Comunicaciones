...
<head>
	...
	<meta name="viewport" content="width=device-width, user-scalable=no,
	 ...
	 <link rel="shortcut icon" type="image/x-icon" href="../img/VaiSoft.png">
	<title>Registrate</title>
</head>
<body>
<div id="particles-js"></div>
	<div class="contenedor">
		<center><img src="../img/VaiSoft.png" alt="" width="300px"></center>
	...
	<script src="../formularios/js-js/particles.js"></script>
  <script src="../formularios/js-js/particulas.js"></script>
  <script src="../formularios/js-js/stats.js"></script>
</body>
</html>